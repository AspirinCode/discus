...
Clazz.load (null, "J.util.MeshSurface", ["java.lang.Float", "java.util.Hashtable", "J.util.ArrayUtil", "$.BS", "$.BSUtil", "$.BoxInfo", "$.C", "$.Escape", "$.Geodesic", "$.JmolList", "$.Measure", "$.P3", "$.SB", "$.TextFormat"], function () {
...
$_M(c$, "resetSlab", 
function () {
this.slabPolygons (J.util.ArrayUtil.getSlabObject (1048587, null, false, null), false);
});
...
return J.util.ArrayUtil.getSlabObject (1679429641, [J.util.Escape.uP (pts[0]), J.util.Escape.uP (pts[1]), J.util.Escape.uP (pts[2]), J.util.Escape.uP (pts[3])], isCap, null);
}var plane = J.util.Escape.uP (s);
if (Clazz.instanceOf (plane, J.util.P4)) return J.util.ArrayUtil.getSlabObject (135266319, plane, isCap, null);
} catch (e) {
