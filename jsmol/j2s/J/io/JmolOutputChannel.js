...
Clazz.load (["java.io.OutputStream"], "J.io.JmolOutputChannel", ["java.io.BufferedWriter", "$.ByteArrayOutputStream", "$.OutputStreamWriter", "J.io.JmolBinary", "J.util.SB"], function () {
...
$_M(c$, "setParams", 
function (viewer, fileName, asWriter, os) {
this.viewer = viewer;
...
return this;
}, "J.viewer.Viewer,~S,~B,java.io.OutputStream");
$_M(c$, "getFileName", 
function () {
...
var ret = this.viewer.fileManager.getBufferedInputStreamOrErrorMessageFromName (this.fileName, null, false, false, bytes, false);
