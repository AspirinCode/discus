...
Clazz.load (["J.api.ApiPlatform"], "J.awtjs2d.Platform", ["java.net.URL", "J.api.Interface", "J.awtjs2d.AjaxURLStreamHandlerFactory", "$.Display", "$.Font", "$.Image", "$.JSFile", "$.Mouse"], function () {
