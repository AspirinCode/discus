...
Clazz.load (["java.net.URLStreamHandler"], "J.awtjs2d.AjaxURLStreamHandler", ["J.awtjs2d.JSURLConnection", "J.util.SB"], function () {
...
function (url) {
return  new J.awtjs2d.JSURLConnection (url);
}, "java.net.URL");
