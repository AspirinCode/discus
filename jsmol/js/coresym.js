...
}System.out.println ("SpaceGroup name: " + this.name);
...
if (atom == null) System.out.println ("HMMM");
...
Clazz.declarePackage ("J.symmetry");
Clazz.load (["J.util.SimpleUnitCell", "$.P3", "J.viewer.JC"], "J.symmetry.UnitCell", ["java.lang.Float", "J.api.Interface", "J.util.BoxInfo", "$.Escape", "$.Matrix4f"], function () {
c$ = Clazz.decorateAsClass (function () {
this.vertices = null;
